"""
Django settings for minijet project.
...
# django-environ: reads environment variables with type casting and defaults.
# In Docker, variables come from docker-compose env_file.
# Without Docker, they come from a .env file in BASE_DIR.
env = environ.Env(
...
WSGI_APPLICATION = "minijet.wsgi.application"
...
# Media files (uploaded by users: contracts PDF, etc.)
